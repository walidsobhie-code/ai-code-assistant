...
[![Try on HF](https://img.shields.io/huggingface/spaces/walidsobhie/ai-code-assistant?color=blue&label=Try+Live+Demo)](https://huggingface.co/spaces/walidsobhie/ai-code-assistant)
